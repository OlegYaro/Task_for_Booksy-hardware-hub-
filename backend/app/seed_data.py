# Raw seed data, copied verbatim from the assessment brief.
# It is intentionally "dirty": duplicate id, future date, brand typo,
# non-ISO date, empty/unknown fields, and physical-damage notes.
# The migration in seed.py is responsible for auditing and normalising it.
RAW_SEED = [
    ...
    {"id": 5, "name": "Dell XPS 15 9510", "brand": "Dell",
     "purchaseDate": "2022-03-15", "status": "Available",
    ...
    {"id": 7, "name": "Sony WH-1000XM4", "brand": "Sony",
     "purchaseDate": "2022-01-12", "status": "In Use",
    ...
    {"id": 11, "name": "MacBook Air M2", "brand": "Apple",
     "purchaseDate": "2023-08-01", "status": "Available",
